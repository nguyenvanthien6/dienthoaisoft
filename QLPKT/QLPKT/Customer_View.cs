...
namespace QLPKT
{
    public partial class Customer_View : Form
    {
         ...
         private void buttom_next_Click(object sender, EventArgs e)
        {
         ...
         private void buttom_search1_Click(object sender, EventArgs e)
         {
             if (type.Text == "Name")
             {
                 searchwith("HoTen");
         ...
         private void buttom_showall1_Click(object sender, EventArgs e)
         {
             SqlDataAdapter adapter;
         ...
         private void buttom_change1_Click(object sender, EventArgs e)
         {
             error.Text = "";
         ...
         private void buttom_update1_Click(object sender, EventArgs e)
         {
         ...
         private void buttom_delete1_Click(object sender, EventArgs e)
         {
             conn.Open();
         ...
         private void buttom_cancel1_Click(object sender, EventArgs e)
         {
             error.Text = "";
             namebox.Enabled = false;
             phone.Enabled = false;
